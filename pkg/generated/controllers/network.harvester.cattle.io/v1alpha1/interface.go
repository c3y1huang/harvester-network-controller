...
func (c *version) HostNetwork() HostNetworkController {
	return NewHostNetworkController(schema.GroupVersionKind{Group: "network.harvester.cattle.io", Version: "v1alpha1", Kind: "HostNetwork"}, "hostnetworks", false, c.controllerFactory)
}
